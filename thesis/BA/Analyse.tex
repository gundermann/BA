...
eine Präsentation unabhängig von der Technik bereitgestellt werden kann. Es
...
\begin{itemize}
  ...
  \item Oben genannte Anforderungen werden nicht komplett umgesetzt
\end{itemize}
...
\begin{itemize}
  ...
  werden bei der deg in Properties-Dateien festgehalten. Das Erstellen und
