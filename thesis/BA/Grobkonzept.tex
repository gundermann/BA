...
eigene \kks entwerfen, deren Wiederverwendungsgrad niedirger ist, als wenn
...
Design), sollte dieses Problem dadurch ausreichend eingädemmt sein. Wichtig ist
...
Konzepte auf die \acrshort{GUI} bezogen werden, wei z.B.
\emph{Personensuche}.\\\\
Um die miteinander komponierten \gks zu
strukturieren ist es notwendig, dass die \g Informationen über
die Anordnung der \gks enthält. Diese Informationen sollen
...
Kapitel \ref{AllgAnforderungen}). Dazu ist weiterhin wichtig, dass den
Bereichen jeweils nur eine Komponente zugeordnet werden kann. Dadurch wird der
...
dafür ist, dass die Anordnung der Komponenten frameworkspezifisch ist
...
Aktionen, die bei Interaktionen mit \gks ausgeführt werden sollen,
...
dass wenn in dem GUI-DSL-Skript einem Attribut ein bestimmter Wert zugewiesen
...
Referenzierung von \gks und Bereichen aus dem GUI-Skript mit den
...
Die doppelte Deklaration widerspricht jedoch der Anforderung, dass so wenig
LOCs wie möglich geschrieben werden sollen, um eine \acrshort{GUI} zu beschreiben (siehe
...
\begin{itemize}
  ...
  \item Interchangeable: Änderung der \acrshort{GUI}
