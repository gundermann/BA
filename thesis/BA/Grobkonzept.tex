...
die Anordnung der \gks enthält. Diese Inforamtionen sollen
...
vorher beschriebenen Komposition von eingebundenen \g-Skripten und
definierten \gks verstärkt werden.\\
...
GUI-DSL-Skript eingebunden ist, verändert werden können. Dadruch werden die
...
Attribute von \gks annehmen können, in Properties-Dateien auszulagern.
Dadruch wird die GUI-DSL weitgehend entlastet. Allerdings muss für die
