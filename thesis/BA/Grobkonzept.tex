...
wird.\\\\
Die Suchfelder aus dem vorherigen Beispiel (siehe Abbildung \ref{suchfeld})
bestehen aus zwei Bereichen (siehe Abbildung
\ref{suchfeldBereich}). Einem Bereich wurde das \emph{Label} zugewiesen und dem
anderen der \emph{Button}.
\myBigFigure{}{}{suchfeldBereich}
\noindent
Die \gui der Suchmaske (siehe Abbildung \ref{suchmaske}) bestehe aus sechs
Bereichen, denen die verwendeten Komponenten (Suchfelder und \emph{Button}) zugeordnet wurden (siehe Abbildung \ref{suchmaskeBereich}).
\myBigFigure{}{}{suchmaskeBereich}
\noindent\\
...
\emph{GUI-Komponen\-ten} zu erfüllen.\\\\
...
\ref{suchfeldAnodnung} und \ref{suchmaskeAnordnung} sind Beispiele für die
Anordnung der Bereiche zu entnehmen. Dabei ist zu betonen, dass der Generator
keinen Einfluss auf den Inhalt der Bereiche hat.
\myBigFigure{}{}{suchfeldAnondnung}
\myBigFigure{}{}{suchmaskeAnordnung}
