...
\begin{itemize}
  ...
  \emph{Implementieren}. Bei der Verwendung von \emph{Xtext} ist für die
  Umsetzung des Prototyps eine \emph{Grammatik} und ein \emph{Generator} von
  Nöten. Für diese beiden Artefakte stellt \emph{Xtext} entsprechende Vorlagen
  bereit, die erweitert werden müssen. Andere Elemente der \gloss{DSL-Umgebung},
  wie der \emph{Parser} oder der \emph{Lexer}, werden von \emph{Xtext} anhand
  der \emph{Grammatik} vollständig generiert, wie in Abbildung \ref{Abb_xtext}
...
\ref{Abb_suchfeldAnordnung} und \ref{Abb_suchmaskeAnordnung} sind Beispiele für
