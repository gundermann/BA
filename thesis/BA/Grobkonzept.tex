...
Das grundsätzliche Konzept muss um ein Artefakt erweitert werden (siehe
Abbildung \ref{Abb_konzept_2}).
...
Das grundsätzliche Konzept wird nochmals erweitert.
Neben den bekannten Artefakten der DSL-Umgebung kommt ein weiteres Artefakt hinzu. Dabei handelt es
