...
da dafür entsprechende Informationen fehlen. Dennoch kann der Klassen-Rumpf und
...
Klassen-Kopf und der Konstruktor werden wie folgt erzeugt (siehe Listing
\ref{LST_HeadComplex}).
...
'''
\end{lstlisting}
Durch die genannten Methoden kann der Generator die beiden DSL-Skripte
...
In den Methoden zur Generierung von UI-Komponenten für die GUI-Klassen sind die
