...
Iteration statt.\\
Ziel ist es, mit dem \emph{Generator} und einem entsprechenden \emph{GUI-Skript} eine
...
\emph{IP-} und \emph{FP-Klassen} sollen nur teilweise generiert werden, womit das folgende
