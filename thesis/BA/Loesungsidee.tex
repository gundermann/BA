...
Frameworks (Swing und wingS) veraltet sind, wird ein neuer Ansatz für die
...
einmal beschrieben werden sollen. Diese Beschreibung soll über eine DSL
erfolgen und sich nicht an bestehende Frameworks orientieren. Grund dafür ist,
...
auf entsprechenden Plattformen ausführen lässt. Für jedes eingesetzte Framework
...
Web-Framework, JavaFX als Framework für den Standalone-Client und
Android als Repräsentant für einen möglichen Mobile-Client}.
\section{Architektur}
