...
die Layout-Datei innerhalb der GUI-Beschreibung anzugeben. Weiterhin wird in den
...
Zusammenfassend werden folgende benötigten Metadaten für die
...
Komponentendefinitionen benötigen durch die oben genannten Änderung folgende
Metadaten.
\begin{itemize}
  \item  Bezeichnung
...
einzelnen Klassen. Die folgenden Abbildungen zeigen diese drei \Ks
...
\ref{LST_Tf+Ta3}) \begin{lstlisting}[{caption = 3.
Iteration:
...
Listing \ref{LST_Tab3} wird eine Tab-Ansicht mit drei Taben beschrieben. Das
