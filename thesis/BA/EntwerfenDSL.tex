...
\begin{tabular}[c]{|l|l|}
			\hline
			\hline
				\textbf{\K} & \textbf{Spezifische Metadaten}\\
				\hline\hline
				Label & 
  		  				Aufschrift
				 \\
...
\end{table}
\noindent
Mit Ausnahme der Metadaten des TabPanes sind alle Angaben zu anderen
...
Dasselbe Prinzip wird bei der sich anschließenden Angabe der Layout-Dateien verwendet.
