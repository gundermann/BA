...
dargestellt werden. Dabei ist zu erwähnen, dass das eingebundene
...
Weiterhin wurde eine Interaktion für den \emph{Button} definiert, deren Aktion ausgelöst
...
Die dazugehörige \emph{Grammatik} befindet sich auf dem beiliegenden Datenträger
...
\end{lstlisting}
\noindent
Die dazugehörige \emph{Grammatik}, welche in der zweiten Iteration entwickelt wurde,
...
\end{lstlisting}
\noindent
Die für diese Arbeit endgültige \emph{Grammatik} ist, wie die \emph{Grammatiken}
