...
\subsection*{Domain Specific Language (DSL)}
  ...
  Programmierern genutzt werden und fachliche DSL von Personen, die keine Programmierer sind (bspw. Kunden) \vcite{voelter}{26}.
...
\subsection*{Grammatik}
  ...
  einer Hierarchie dargestellt werden (\emph{Chomsky-Hierarchie})
  \vcite{hedtstueck}{32f}. Bei Programmiersprachen handelt es sich
  um \emph{kontextfreie Sprachen}. Diese sind entscheidbar
  und können somit von einem Compiler verarbeitet werden 
...
\subsection*{Parser}
  ...
  Form eines Syntax-Baums (AST) generiert \vcite{fowler}{47}. Ein solcher Baum
  ist laut Martin Fowler et al. eine weitaus nutzbarere Darstellung dessen, was mit dem DSL-Skript dargestellt werden soll. 
...
vonstatten geht und mit weniger Kosten realisierbar ist \vcite{mdsd}{71}.\\
...
Modelle Quellcode oder Funktionalitäten beschreiben und diese in der Evolution
der Software immer wiederverwendet werden können \vcite{mdsd}{72}. Somit wird redundanter
...
\subsubsection*{Ausdruckskraft}
 ...
 \vcite{ghosh}{20}. Sind diese Empfehlungen umgesetzt, ist wächst das
...
\subsubsection*{Höhere Qualität}
  ...
  was ebenso zu qualitativ höherwertigen Quellcode führt \vcite{ghosh}{21}.
...
\subsubsection*{Verbesserte Produktivität bei der Entwicklung der
  ...
  Verglöeich zu GPL-Code, wodurch DSL-Code einfacher
  ...
  angestrebt 
  \vcite{fowler}{33}. Allerdings ist der Entwickler zur Einhaltung dieser
...
\subsubsection*{Plattformunabhängigkeit}
  ...
  den praktischen Teil dieser Arbeit interessant. (Allerdings weniger in Bezug auf Logik, sondern in
...
\subsubsection*{Kulturelle Herausforderungen}
  ...
  Solche kulturellen Probleme entstehen i.d.R. dann, wenn etwas Neues eingeführt
...
\vcite{fowler}{246}. Tabelle \ref{tab_RD_Implementierung} enthält die Implementierungsmöglichkeiten von einfachen Grammatik-Regeln.
\begin{table}[!htb]
\centering
\small
			\begin{tabular}[c]{|l|l|}
