...
Möglichkeit über den \emph{Parse Tree} zu iterieren. Bei Lisp-Codes handelt es sich
bereits um einen \emph{Parse Tree} von verschachtelten Listen. Bei der Iteration über
...
als \emph{Fluent Interface} bezeichnet. Das \emph{Fluent Interface} steht laut Voelter et
al. zwischen dem API und einer internen \emph{DSL} \vcite{voelter}{50}. Ein einfaches
Beispiel für ein \emph{Fluent Interface} wird von Martin Fowler et al.
beschrieben. 
\begin{lstlisting}[caption = Beispiel: \emph{Annotationen}]
computer()
	.processor()
		.cores(2)
		.speed(2500)
...
Definitionen von \emph{Annotationen} variieren bei Verwendung unterschiedlicher
...
(Validierungsregeln) \vcite{ghosh}{218}. Wird der \emph{Parsergenerator}
...
\myBigFigureCited{parsercombinator.jpg}{Funktionsweise von Parserkombinatoren}{
(in Anlehnung an \cite[S.243]{ghosh}) }{parsercombinator} 
\noindent
Bezogen darauf, dass ein Parser aus Funktionen besteht, sind diese
Parserkombinatoren Funktionen erster Ordnung, die unterschiedlich kombiniert
...
Nachteil ist. Daher bezeichnen Martin Fowler et al. Parserkombinatoren auch als
Mittelweg zwischen \emph{RD-Parsern} und Parser-Generatoren
\vcite{fowler}{261}.
