...
\begin{itemize}
  ...
  \cite[S.272]{fowler}
\end{itemize}
\subsection{Recursive Decent Parser (RD-Parser)}
...
\cite[S.243]{ghosh}, \cite[S.256]{fowler} Durch diese Kombination wird eine
Struktur gebildet, welche das semantische
