...
\myBigFigureCited{mdsd.jpg}{Die grundlegende Idee hinter dem \emph{MDSD}}{
...
beschrieben. 
\begin{lstlisting}[caption = Beispiel: \emph{Fluent Interface}]
computer()
	.processor()
		.cores(2)
		.speed(2500)
...
\end{lstlisting}\\
		...
		RD-Parser]{Implementierung einfacher Grammatikregeln mit einem
		\emph{RD-Parser}
		\vcite{fowler}{248}}
...
\emph{Parserkombinatoren}}{ (in Anlehnung an \cite[S.243]{ghosh})
}{parsercombinator}
\noindent
